...
template <> constexpr inline auto Logger::qt_create_metaobjectdata<qt_meta_tag_ZN6LoggerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'logPacket'
        QtMocHelpers::SlotData<void(const TelemetryPacket &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->logPacket((*reinterpret_cast<std::add_pointer_t<TelemetryPacket>>(_a[1]))); break;
        default: ;
        }
    }
}
