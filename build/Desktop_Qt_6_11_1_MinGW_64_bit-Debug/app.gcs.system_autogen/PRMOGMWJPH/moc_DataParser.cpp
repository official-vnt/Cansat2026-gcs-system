...
namespace {
struct qt_meta_tag_ZN10DataParserE_t {};
} // unnamed namespace

template <> constexpr inline auto DataParser::qt_create_metaobjectdata<qt_meta_tag_ZN10DataParserE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<DataParser, qt_meta_tag_ZN10DataParserE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DataParser::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DataParserE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DataParserE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10DataParserE_t>.metaTypes,
    nullptr
} };
...
void *DataParser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DataParserE_t>.strings))
