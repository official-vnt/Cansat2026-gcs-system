...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SerialWorker::*)(const QByteArray & )>(_a, &SerialWorker::dataReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialWorker::*)(const QString & )>(_a, &SerialWorker::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialWorker::*)()>(_a, &SerialWorker::portOpened, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialWorker::*)()>(_a, &SerialWorker::portClosed, 3))
            return;
    }
}
...
// SIGNAL 0
void SerialWorker::dataReady(const QByteArray & _t1)
{
